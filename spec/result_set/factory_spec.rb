...
describe ResultSet::Factory do
  ...
  let(:the_instance) {
    ResultSet::Factory.new(Indexes::Plaintext, Engines::Base, some_term)
  }
  ...
  describe "Instance Methods" do
    ...
    it "#get_results passes a list off to an engine to be scored" do
      records = ['a', 'b', 'c']
      index_class = 'placeholder'

      Engines::Base.should_receive(:score).
        with(records, some_term, 0, index_class)
