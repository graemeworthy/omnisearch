...
describe Cache::IndexCache do

  let(:a_key)            { 'something' }
  let(:a_namespaced_key) { "index_cache:#{a_key}" }
  let(:a_value)          { 'a complicated return object' }
  let(:the_class)        { Cache::IndexCache }
  ...
  describe 'Class Methods' do
    ...
    describe '##namespace_key' do
      ...
      it 'should return a string with "index_cache" prepended' do
